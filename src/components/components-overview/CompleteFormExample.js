...
export default class CompleteFormExample extends React.Component {
  state={email:''}
  render () {
    return (
  <ListGroup flush>
          ...
          <Form onSubmit={(e)=>e.preventDefault()}>
            <Row form>
              <Col md="6" className="form-group">
                ...
                <FormInput onChange={(e)=>{this.setState({email:e.target.value})}}
                  id="feEmailAddress"
                  type="email"
                  placeholder="Email"
                />
            ...
            <Button type="submit" onClick={()=>alert(this.state.email)}>Create New Account</Button>
          </Form>
        </Col>
      </Row>
    </ListGroupItem>
